    ...
    return (
      <div className="space-y-5 fade-in-up">
        ...
        <div className="grid grid-cols-2 gap-3">
          {/* Total LGAs */}
          <div className="glass-card rounded-2xl p-4 shimmer">
        ...
        <div className="glass-card rounded-2xl p-5">
          <div className="flex items-center justify-between mb-1">
            <h3 className="text-sm font-bold text-white/90 tracking-wide">Risk Distribution</h3>
        ...
        <div className="glass-card rounded-2xl p-5">
          <h3 className="text-sm font-bold text-white/90 tracking-wide mb-1">Detailed Breakdown</h3>
  ...
  const renderLGAProfile = () => {
    ...
    return (
      <div className="space-y-5 fade-in-up">
        ...
        {/* ── Risk Badge ── */}
        <div
          className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full font-bold text-sm text-white shadow-lg"
          style={{
            background: `linear-gradient(135deg, ${riskColor}, ${riskColor}bb)`,
            boxShadow: `0 4px 20px ${riskColor}44`,
          }}
        >
        ...
        <div className="glass-card rounded-2xl p-5">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-bold text-white/90">Poverty Probability</h3>
            <span
        ...
        <div className="glass-card rounded-2xl p-5">
          <h3 className="text-sm font-bold text-white/90 mb-1">Comparative Analysis</h3>
        ...
        {/* ── Download ── */}
        <button className="w-full glass-card rounded-2xl px-5 py-3.5 text-white font-semibold text-sm hover:bg-white/10 transition-all flex items-center justify-center gap-2.5 group">
          <svg
